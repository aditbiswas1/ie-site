...
def evaluate_resume(request,resume_id):
	rounds = ['Not Qualified','Resume Evaluation Pending','Personal Interview','Group Discussion','Final Interview','Selected']
	...
	return render_to_response('flatpages/form_layout.html',{'resume_form':form,'resume':models.Resume.objects.get(id=resume_id)},context_instance=RequestContext(request))
